...
contract VNR1Crowdsale {
  ...
  */
   ...
   uint256[5] fundingLimit = [120000, 18000, 6000, 3000, 900000]; //Max Rave Available per tier
  ...
  function VNR1Crowdsale(uint256 _startTime, uint256 _endTime, uint256 _cap, address _wallet) public {
    ...
    owner = msg.sender;
    address _tokenAddr = 0x080f89FE95A9f152dbb0708bF88aD6De8bfce55A; //Token Contract Address
